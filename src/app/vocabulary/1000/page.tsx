...
import { TopicSessionBrowser } from "@/features/vocabulary-1000/components/TopicSessionBrowser";

export default function Vocabulary1000Page() {
  return (
